...
public class GridDocAdapter extends RecyclerView.Adapter<GridDocAdapter.MyClassView> implements Filterable {

    private OnItemClickListener listener;

    private Activity activity;
    private ArrayList<String> imgfoldername = new ArrayList<>();
    ...
    public GridDocAdapter(Activity activity, ArrayList<String> imgfoldername) {
    ...
    public MyClassView onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_grid_doc, parent, false);
...
//        Log.e("LLLLL_Size: ", String.valueOf(foldername.size()));
